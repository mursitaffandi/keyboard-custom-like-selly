...
import com.inspiraspace.jokulid.keylogger.Emoji.Cars;
import com.inspiraspace.jokulid.keylogger.Emoji.Electr;
import com.inspiraspace.jokulid.keylogger.Emoji.Emojicon;
import com.inspiraspace.jokulid.keylogger.Emoji.Food;
import com.inspiraspace.jokulid.keylogger.Emoji.Nature;
import com.inspiraspace.jokulid.keylogger.Emoji.People;
import com.inspiraspace.jokulid.keylogger.Emoji.Sport;
import com.inspiraspace.jokulid.keylogger.Emoji.Symbols;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
    ...
    OnEmojiconButtonBackClickedListener onEmojiconButtonBackClickedListener;
    ...
    /**
     * Set the listener for the event when toolbar back button on emojicon popup is clicked
     */
    public void setOnEmojiButtonBackClickedListener(OnEmojiconButtonBackClickedListener listener) {
        this.onEmojiconButtonBackClickedListener = listener;
    }
...
//        showAtLocation(rootView, Gravity.BOTTOM, 0, 0);
    ...
    private View createCustomView() {
        ...
        view.findViewById(R.id.emojis_backspace).setOnTouchListener(new RepeatListener(500, 50, new View.OnClickListener() {
        ...
        view.findViewById(R.id.btnBackEmoji).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onEmojiconButtonBackClickedListener != null) {
                    onEmojiconButtonBackClickedListener.onEmojiconButtonBackClickedListener(v);
                }
            }
        });
    ...
    public interface OnEmojiconButtonBackClickedListener {
        void onEmojiconButtonBackClickedListener(View v);
    }
